...
public class Pdf {
	...
	public void pdfGenerator(int id) {
		...
		try {
			...
			document.add(new Paragraph("Terug op:       " + terugdatum + "\n\n",fonts[0]));
			...
			document.add(new Paragraph("Verkoopdatum:       " + reportDate + "\n",fonts[1]));
	...
	public static void main(String[] args) {
		...
		TicketDao tDao = new TicketDao();
		Ticket ticket = tDao.getTicket(11);
		...
		try {
		    ...
		    document.add(image);
			document.add(new Paragraph("Ticket nummer:  " + 11 + "\n\n",fonts[0]));
			document.add(new Paragraph("GELDIG VOOR EEN REIS\n",fonts[1]));
			if(ticket.getTerugDatum() == null){
				document.add(new Paragraph("HEENREIS",fonts[1]));
			}
