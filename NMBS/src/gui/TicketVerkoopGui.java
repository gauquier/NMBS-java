		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnVerkoop) {
				if (txtPrijs.getText().isEmpty()) {
					...
					if (!isOffline) {
						ticket = new Ticket(0, MedewerkerDAO.getMedewerkerByLogin(Login.getLoginId()).getId(),
								txtVan.getText(), txtNaar.getText(),
						...
						ticket = new Ticket(0, 0,
								txtVan.getText(), txtNaar.getText(), 0, Double.parseDouble(txtPrijs.getText()),
								VerkoopType.VerkoopTypeCasting((String) comboVerkoopType.getSelectedItem()), 0,
								(int) klasse.getValue(), (int) aantal.getValue(), Calendar.getInstance().getTime(),
								converter((int) heenDag.getValue(), (int) heenMaand.getValue(),
										(int) heenJaar.getValue()),
