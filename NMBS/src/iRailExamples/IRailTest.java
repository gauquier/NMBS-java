...
public class IRailTest {
	...
	private static String URLMaker(String base, String departure, String arrival) {
		...
		builder.append(base);
		builder.append(IRailTest.STRFormatter(departure));
		builder.append("&to=");
		builder.append(IRailTest.STRFormatter(arrival));
	...
	private static String URLMaker(String base, String request) {
		StringBuilder builder = new StringBuilder();
		builder.append(base);
		builder.append(IRailTest.STRFormatter(request));
	...
	public static void main(String[] args) throws Exception {
		...
		case 1:// tussen twee stations
			...
			System.out.println(IRailTest
					.getHTML(IRailTest.URLMaker("https://api.irail.be/connections/?from=", departure, arrival)));
			break;
		case 2:// doorkomsten van ��n station
			...
			System.out.println(
					IRailTest.getHTML(IRailTest.URLMaker("https://api.irail.be/liveboard/?station=", request)));
			break;
		default:
			break;
		}
