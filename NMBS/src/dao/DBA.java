...
public class DBA {
	private String sql;
	private String tableName;
	private enum Type{SELECT, INSERT, UPDATE, NONE}
	private Type type = Type.NONE;
	boolean isWhere = false;
	boolean valueAdded = false;
	...
	private ResultSet rs = null;
		...
		public void createSelect(String tableName, String columnName)//SELECT columnName FROM tableName
		{
			reset();
		...
		public void createUpdate(String tableName, String columnName, int value) // UPDATE tableName SET columnName = value
		{
			createUpdate(tableName, columnName, (double)value);
		}
		public void createUpdate(String tableName, String columnName, boolean value) // UPDATE tableName SET columnName = value
		{
			reset();
		...
		public void createInsert(String tableName) // INSERT INTO tableName Values (0,...    (autoset id)
		{
			reset();
...
>>>>>>> 0d399f506fada564dc007acd8f7e0edee0e2b076
